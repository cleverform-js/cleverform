...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	//AMD...
		...
		define("CleverForm", [], factory);
	//CommonJS...
	else if(typeof exports === 'object')
		exports["CleverForm"] = factory();
	//Root...
	else
		root["CleverForm"] = factory();
})(this, function() {
...
// EXTERNAL MODULE: ./node_modules/ts-polyfill/dist/ts-polyfill.js
var ts_polyfill = __webpack_require__(0);

// CONCATENATED MODULE: ./src/core/global/App.ts
var App;
(function (App) {
    App["Name"] = "CleverForm";
    App["Namespace"] = "CleverForm";
    App["Initial"] = "CF";
})(App || (App = {}));

// CONCATENATED MODULE: ./src/core/global/Warning_Code.ts
var Warning_Code;
(function (Warning_Code) {
    Warning_Code[Warning_Code["Unknown"] = 5000] = "Unknown";
})(Warning_Code || (Warning_Code = {}));

// CONCATENATED MODULE: ./src/core/global/Error_Code.ts
var Error_Code;
(function (Error_Code) {
    Error_Code[Error_Code["Unknown"] = 1000] = "Unknown";
    Error_Code[Error_Code["Constructor_No_New_Keyword"] = 1001] = "Constructor_No_New_Keyword";
    Error_Code[Error_Code["Form_Not_Found"] = 1002] = "Form_Not_Found";
    Error_Code[Error_Code["Form_Id_Not_In_Form_Tag"] = 1003] = "Form_Id_Not_In_Form_Tag";
    Error_Code[Error_Code["Form_Already_Initialized"] = 1004] = "Form_Already_Initialized";
    Error_Code[Error_Code["Unknown_Rule"] = 1005] = "Unknown_Rule";
    Error_Code[Error_Code["Wrong_Rule_Param_Type"] = 1006] = "Wrong_Rule_Param_Type";
    Error_Code[Error_Code["Rules_Collision"] = 1007] = "Rules_Collision";
    Error_Code[Error_Code["Custom_Rule_Error"] = 1008] = "Custom_Rule_Error";
    Error_Code[Error_Code["Custom_ErrMsg_Error"] = 1009] = "Custom_ErrMsg_Error";
})(Error_Code || (Error_Code = {}));

// CONCATENATED MODULE: ./src/core/global/index.ts




// CONCATENATED MODULE: ./src/core/classes/CF_Error.ts

var CF_Error_CF_Error = (function () {
    function CF_Error(code, concreteMsg) {
        this.concreteMsg = concreteMsg;
        var details = this.getDetails(code);
        this.code = details.code;
        this.desciption = details.desciption;
        this.log();
    }
    CF_Error.prototype.log = function () {
    ...
    CF_Error.prototype.getDetails = function (code) {
        switch (code) {
            case Error_Code.Form_Not_Found:
                return {
                    code: Error_Code.Form_Not_Found,
                    desciption: 'Form not found in the DOM with the provided `form id`.',
                };
            case Error_Code.Form_Id_Not_In_Form_Tag:
                return {
                    code: Error_Code.Form_Id_Not_In_Form_Tag,
                    desciption: "Provided `form id` was used by non `<form>` tag/element in the DOM.",
                };
            case Error_Code.Form_Already_Initialized:
                return {
                    code: Error_Code.Form_Already_Initialized,
                    desciption: 'Provided form id was already initialized by other CleverForm instance.',
                };
            case Error_Code.Constructor_No_New_Keyword:
                return {
                    code: Error_Code.Constructor_No_New_Keyword,
                    desciption: 'CleverForm is a `constructor` function and should be called with the `new` keyword.',
                };
            case Error_Code.Unknown_Rule:
                return {
                    code: Error_Code.Unknown_Rule,
                    desciption: 'Unknown validation rule used.'
                };
            case Error_Code.Rules_Collision:
                return {
                    code: Error_Code.Rules_Collision,
                    desciption: 'Rule names collision.'
                };
            case Error_Code.Custom_Rule_Error:
                return {
                    code: Error_Code.Custom_Rule_Error,
                    desciption: 'Custom validation rule error.'
                };
            case Error_Code.Custom_ErrMsg_Error:
                return {
                    code: Error_Code.Custom_ErrMsg_Error,
...
/* harmony default export */ var classes_CF_Error = (CF_Error_CF_Error);

// CONCATENATED MODULE: ./src/core/rules/any/required.ts
var required = {
    name: 'required',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        field === null || field === void 0 ? void 0 : field.toggleAttribute('required', true);
        return null;
    },
...
// CONCATENATED MODULE: ./src/core/util/index.ts
function randomString(length, withNumber) {
    if (withNumber === void 0) { withNumber = false; }
    var result = '';
...
var fileSizeUnits = ['bytes', 'KB', 'MB', 'GB'];
function convertFileSize(bytes, unit) {
    switch (unit) {
        case 'KB':
            return bytes / 1024;
            break;
...
// CONCATENATED MODULE: ./src/core/rules/any/minLen.ts
...
var minLen = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        var paramsArr = ruleParamsStr.split(',');
        var min = paramsArr[0];
        ...
        field === null || field === void 0 ? void 0 : field.setAttribute('minlength', min);
        return {
            min: parseInt(min)
        };
    },
...
// CONCATENATED MODULE: ./src/core/rules/any/maxLen.ts
...
var maxLen = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        if (paramsArr.length > 1)
            console.warn("Field '" + fieldName + "' - '" + this.name + "' rule expects only 1 parameter.\n " + paramsArr.length + " parameters detected.");
        field === null || field === void 0 ? void 0 : field.setAttribute('maxlength', max);
        return {
            max: parseInt(max)
        };
    },
...
// CONCATENATED MODULE: ./src/core/rules/any/alpha.ts
var alpha = {
    name: 'alpha',
    default: true,
...
// CONCATENATED MODULE: ./src/core/rules/any/alphaNum.ts
var alphaNum = {
    name: 'alphaNum',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName) {
...
// CONCATENATED MODULE: ./src/core/rules/any/alphaDash.ts
var alphaDash = {
    name: 'alphaDash',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName) {
...
// CONCATENATED MODULE: ./src/core/rules/any/betweenLen.ts
...
// CONCATENATED MODULE: ./src/core/rules/any/matched.ts
var matched = {
    name: 'matched',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        var paramsArr = ruleParamsStr.split(',');
        var fieldToMatch = paramsArr[0];
        if (!(field === null || field === void 0 ? void 0 : field.parentForm.formNode.querySelector("input[name=\"" + fieldToMatch + "\"]")))
    ...
    validate: function (value, params, fieldNode, field) {
        ...
        var fieldToMatch_value = field === null || field === void 0 ? void 0 : field.parentForm.fields[fieldToMatch].val();
        return value === fieldToMatch_value;
    }
};

// CONCATENATED MODULE: ./src/core/rules/any/ip.ts
...
// CONCATENATED MODULE: ./src/core/rules/any/ipv4.ts
...
// CONCATENATED MODULE: ./src/core/rules/any/ipv6.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_email/email.ts
var email = {
    name: 'email',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName) {
...
// CONCATENATED MODULE: ./src/core/rules/input_number/min.ts
...
var min_min = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        var paramsArr = ruleParamsStr.split(',');
        var min = (_a = paramsArr[0]) === null || _a === void 0 ? void 0 : _a.trim();
        if (!isNumeric(min))
            throw ("Field '" + fieldName + "' - '" + this.name + "' rule expects a valid number parameter. Param '" + min + "' detected.");
        if (paramsArr.length > 1)
            console.warn("Field '" + fieldName + "' - '" + this.name + "' rule expects only 1 parameter.\n " + paramsArr.length + " parameters detected.");
        field === null || field === void 0 ? void 0 : field.setAttribute('min', min);
        return {
            min: parseFloat(min)
        };
    },
...
// CONCATENATED MODULE: ./src/core/rules/input_number/max.ts
...
var max_max = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        if (!ruleParamsStr)
            throw ("Field '" + fieldName + "' - '" + this.name + "' rule expects an number parameter.");
        var paramsArr = ruleParamsStr.split(',');
        var max = (_a = paramsArr[0]) === null || _a === void 0 ? void 0 : _a.trim();
        if (!isNumeric(max))
            throw ("Field '" + fieldName + "' - '" + this.name + "' rule expects a valid number parameter. Param '" + max + "' detected.");
        if (paramsArr.length > 1)
            console.warn("Field '" + fieldName + "' - '" + this.name + "' rule expects only 1 parameter.\n " + paramsArr.length + " parameters detected.");
        field === null || field === void 0 ? void 0 : field.setAttribute('max', max);
        return {
            max: parseFloat(max)
        };
    },
...
// CONCATENATED MODULE: ./src/core/rules/input_number/numeric.ts

var numeric = {
    name: 'numeric',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        field === null || field === void 0 ? void 0 : field.setAttribute('step', "any");
        return null;
    },
    validate: function (value, params) {
...
// CONCATENATED MODULE: ./src/core/rules/input_number/integer.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_number/positive.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_number/negative.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_file/extensions.ts
var groupedExt = {
...
var extensions = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        var rawExtentions = ruleParamsStr.trim().split(',');
        var acceptExts = [];
        var friendlyExts = [];
        rawExtentions.forEach(function (elem) {
            var ext = elem.trim();
            if (!ext)
                return;
            switch (ext) {
                ...
                case 'image':
                    ...
                    break;
                case 'msWord':
                    acceptExts = acceptExts.concat(groupedExt.msWord.map(function (ext) { return '.' + ext; }));
                    friendlyExts.push('Word');
                    break;
                case 'msExcel':
                    acceptExts = acceptExts.concat(groupedExt.msExcel.map(function (ext) { return '.' + ext; }));
                    friendlyExts.push('Excel');
                    break;
                case 'msPowerPoint':
                    acceptExts = acceptExts.concat(groupedExt.msPowerPoint.map(function (ext) { return '.' + ext; }));
        ...
        if (friendlyExts.length > 1) {
            var lastfriendlyExt = friendlyExts.pop();
            _extentionNames = friendlyExts.join(', ').concat(" or " + lastfriendlyExt);
        }
        else {
            _extentionNames = friendlyExts[0];
        }
        field === null || field === void 0 ? void 0 : field.setAttribute('accept', acceptExts.join(','));
        return {
    ...
    validate: function (value, params, fieldNode) {
        var fileLists = fieldNode === null || fieldNode === void 0 ? void 0 : fieldNode.files;
        if (fileLists.length === 0)
            return true;
        var allExtentions = [];
        var extentions = params.extentions;
        ...
        for (var i = 0; i < fileLists.length; i++) {
            ...
            var ext = fileName.slice(last_dot + 1).toLowerCase();
...
// CONCATENATED MODULE: ./src/core/rules/input_file/maxFS.ts
...
var maxFS = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName) {
        ...
        var paramsArr = ruleParamsStr.split(',').map(function (str) { return str.trim(); });
        var maxSize = paramsArr[0];
        var sizeUnit = paramsArr[1] || 'bytes';
    ...
    validate: function (value, params, fieldNode) {
        ...
        if (fileLists.length === 0)
            return true;
        for (var i = 0; i < fileLists.length; i++) {
            var fileSize = convertFileSize(fileLists[i].size, params.sizeUnit);
...
// CONCATENATED MODULE: ./src/core/rules/input_file/minFS.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_file/betweenFS.ts
...
var betweenFS = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName) {
        ...
        var paramsArr = ruleParamsStr.split(',').map(function (str) { return str.trim(); });
        var minSize = paramsArr[0];
        var maxSize = paramsArr[1];
        var sizeUnit = paramsArr[2] || 'bytes';
        if (!isPositive(minSize))
...
// CONCATENATED MODULE: ./src/core/rules/input_file/maxTFS.ts
...
var maxTFS = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        ...
        if (paramsArr.length > 2)
            console.warn("Field '" + fieldName + "' - '" + this.name + "' rule expects only 2 parameters.\n " + paramsArr.length + " parameters detected.");
        field === null || field === void 0 ? void 0 : field.toggleAttribute('multiple', true, true);
        return {
...
// CONCATENATED MODULE: ./src/core/rules/input_file/minTFS.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_file/betweenTFS.ts
...
var betweenTFS = {
    ...
    validate: function (value, params, fieldNode) {
        console.log(fieldNode === null || fieldNode === void 0 ? void 0 : fieldNode.files);
        var fileLists = fieldNode === null || fieldNode === void 0 ? void 0 : fieldNode.files;
        if (fileLists.length === 0)
            return true;
        var totalFileSize = 0;
...
// CONCATENATED MODULE: ./src/core/rules/input_file/minFiles.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_file/maxFiles.ts
...
// CONCATENATED MODULE: ./src/core/rules/input_file/exactFiles.ts
...
var exactFiles = {
    ...
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
        if (!ruleParamsStr)
            throw ("Field '" + fieldName + "' - '" + this.name + "' rule expects 1 parameter.");
        var paramsArr = ruleParamsStr.split(',').map(function (str) { return str.trim(); });
        var exactFileCount = paramsArr[0];
...
// CONCATENATED MODULE: ./src/core/rules/input_checkbox/accepted.ts
var accepted = {
    name: 'accepted',
    default: true,
    checkAndSerializeParams: function (ruleParamsStr, fieldName, field) {
...
// CONCATENATED MODULE: ./src/core/states/validationRules.ts



var validationRules_ValidationRule = (function () {
    function ValidationRule() {
        this.rules = {};
        this.addRule(required);
        this.addRule(accepted);
        this.addRule(email);
        this.addRule(matched);
        this.addRule(ip);
        this.addRule(ipv4);
        this.addRule(ipv6);
        this.addRule(minLen);
        this.addRule(maxLen);
        this.addRule(betweenLen);
        this.addRule(alpha);
        this.addRule(alphaNum);
        this.addRule(alphaDash);
        this.addRule(min_min);
        this.addRule(max_max);
        this.addRule(numeric);
        this.addRule(integer);
        this.addRule(positive);
        this.addRule(negative);
        this.addRule(extensions);
        this.addRule(maxFS);
        this.addRule(minFS);
        this.addRule(betweenFS);
        this.addRule(maxTFS);
        this.addRule(minTFS);
        this.addRule(betweenTFS);
        this.addRule(minFiles);
        this.addRule(maxFiles);
        this.addRule(exactFiles);
    }
    ValidationRule.prototype.addRule = function (ruleObj) {
        if (!this.rules.hasOwnProperty(ruleObj.name)) {
            this.rules[ruleObj.name] = ruleObj;
        }
        else {
            throw new classes_CF_Error(Error_Code.Rules_Collision, "Validation rule " + ruleObj.name + " already exists!. Use other name instead.");
        }
    };
    ValidationRule.getInstance = function () {
...
var rulesContainer = validationRules_ValidationRule.getInstance();
var validationRules = rulesContainer.rules;


// CONCATENATED MODULE: ./src/core/global/Default.ts
var Default;
(function (Default) {
    Default[Default["Submit_Delay"] = 500] = "Submit_Delay";
    Default[Default["Rerending_Delay"] = 300] = "Rerending_Delay";
    Default["Lang"] = "en";
    Default["fieldSuccessClass"] = "cf-field-success";
    Default["fieldErrorClass"] = "cf-field-error";
    Default["labelSuccessClass"] = "cf-label-success";
    Default["labelErrorClass"] = "cf-label-error";
})(Default || (Default = {}));

// CONCATENATED MODULE: ./src/core/classes/Label.ts

var Label_Label = (function () {
    ...
    Label.prototype.display = function () {
        var _a, _b, _c, _d;
        this.removeClass(((_b = (_a = this.field.parentForm) === null || _a === void 0 ? void 0 : _a.cssClass) === null || _b === void 0 ? void 0 : _b.labelError) || Default.labelErrorClass);
        if (this.labelNode) {
            this.labelNode.innerText = '';
            if (this.field.hasError()) {
                this.addClass(((_d = (_c = this.field.parentForm) === null || _c === void 0 ? void 0 : _c.cssClass) === null || _d === void 0 ? void 0 : _d.labelError) || Default.labelErrorClass);
                var that_1 = this;
                setTimeout(function () {
                    that_1.labelNode.innerText = that_1.field.validationError;
                }, Default.Rerending_Delay);
            }
        }
    };
    Label.prototype.addClass = function (styleClass) {
        var that = this;
        setTimeout(function () {
            var _a;
            (_a = that.labelNode) === null || _a === void 0 ? void 0 : _a.classList.add(styleClass);
        }, Default.Rerending_Delay);
    };
    Label.prototype.removeClass = function (styleClass) {
        var _a;
        (_a = this.labelNode) === null || _a === void 0 ? void 0 : _a.classList.remove(styleClass);
    };
    return Label;
}());
/* harmony default export */ var classes_Label = (Label_Label);

// CONCATENATED MODULE: ./src/core/assets/errorMessagesTemplate.ts
...
function addCustomErrorMsg(ruleName, message) {
    if (typeof message !== "string" || message.trim() == '') {
        throw new classes_CF_Error(Error_Code.Custom_ErrMsg_Error, "error message must be a valid string");
    }
    errorMessagesTemplate.custom[ruleName] = message;
}


// CONCATENATED MODULE: ./src/core/classes/Field.ts
...
var Field_Field = (function () {
    function Field(parentForm, fieldNode, fieldName, customName, tagName, type, rawRules) {
        ...
        this.label = new classes_Label(this);
    ...
    Field.prototype.val = function () {
        if (this.type === "checkbox") {
            ...
            var emails = this.fieldNode.value.trim();
            return emails ? emails.split(",") : [];
        }
        else if (this.type === "radio") {
            var checkedRadio = this.parentForm.formNode.querySelector("input[name=\"" + this.fieldName + "\"]:checked");
            return (checkedRadio === null || checkedRadio === void 0 ? void 0 : checkedRadio.value) || "";
        }
        else if (this.tagName === "SELECT" && this.fieldNode.multiple) {
            var values = [];
            var options = this.fieldNode
                .options;
    ...
    Field.prototype.addClass = function (styleClass) {
        var _this = this;
        var that = this;
        setTimeout(function () {
            if (_this.type === 'radio') {
                var radios = that.parentForm.formNode.querySelectorAll("input[name=\"" + that.fieldName + "\"]");
    ...
    Field.prototype.removeClass = function (styleClass) {
        var that = this;
        if (this.type === 'radio') {
            var radios = that.parentForm.formNode.querySelectorAll("input[name=\"" + that.fieldName + "\"]");
            radios.forEach(function (radioNode) {
    ...
    ;
    Field.prototype.getSerializeRulesAndParam = function () {
        if (!this.rawRules) {
            console.warn("Field " + this.fieldName + " has no validation rules.");
            return null;
        }
        var rulesWithParamArr = this.rawRules.split('|');
        var serializedRules = {};
        for (var i = 0; i < rulesWithParamArr.length; i++) {
            var ruleAndParams = rulesWithParamArr[i].split(':');
            var ruleName = ruleAndParams[0].trim();
            var paramsStr = ruleAndParams[1];
            if (ruleName) {
    ...
    Field.prototype.verifyRuleNameAndParams = function (ruleName, paramsStr, fieldName) {
        if (validationRules.hasOwnProperty(ruleName)) {
            ...
            throw new classes_CF_Error(Error_Code.Unknown_Rule, ruleName + " rule does not exists");
        }
    };
    Field.prototype.hasError = function () {
        return this.validationError ? true : false;
    };
    Field.prototype.emptyError = function () {
        this.validationError = null;
    };
    ...
    Field.prototype.validate = function () {
        ...
        fieldRulesLoop: for (var ruleName in rules) {
            if (rules.hasOwnProperty(ruleName)) {
                var value = this.val();
                var params = (_a = rules === null || rules === void 0 ? void 0 : rules[ruleName]) === null || _a === void 0 ? void 0 : _a.params;
                var validationPassed = validationRules[ruleName].validate(value, params, this.fieldNode, this);
    ...
    Field.prototype.generateErrorMsg = function (ruleName, params) {
        var _a;
        var finalFieldName = this.customName || this.fieldName;
        var lang = ((_a = this.parentForm.settings) === null || _a === void 0 ? void 0 : _a.lang) || Default.Lang;
        var errorMsgTemplete = errorMessagesTemplate["custom"][ruleName] || errorMessagesTemplate[lang][ruleName];
        if (!errorMsgTemplete) {
            throw new Error("'" + ruleName + "' rule has no error message template defined.(Internal error)");
        }
        var errorMsg = errorMsgTemplete === null || errorMsgTemplete === void 0 ? void 0 : errorMsgTemplete.replace(":fieldName", finalFieldName);
    ...
    Field.prototype.displayMsg = function () {
        var _a, _b, _c, _d;
        this.resetCss();
        if (this.hasError()) {
            this.addClass(((_b = (_a = this.parentForm) === null || _a === void 0 ? void 0 : _a.cssClass) === null || _b === void 0 ? void 0 : _b.fieldError) || Default.fieldErrorClass);
        }
        else {
            if (this.val())
                this.addClass(((_d = (_c = this.parentForm) === null || _c === void 0 ? void 0 : _c.cssClass) === null || _d === void 0 ? void 0 : _d.fieldSuccess) || Default.fieldSuccessClass);
        }
        this.label.display();
    };
    Field.prototype.resetCss = function () {
        var _a, _b, _c, _d;
        this.removeClass(((_b = (_a = this.parentForm) === null || _a === void 0 ? void 0 : _a.cssClass) === null || _b === void 0 ? void 0 : _b.fieldError) || Default.fieldErrorClass);
        this.removeClass(((_d = (_c = this.parentForm) === null || _c === void 0 ? void 0 : _c.cssClass) === null || _d === void 0 ? void 0 : _d.fieldSuccess) || Default.fieldSuccessClass);
    };
    Field.prototype.setAttribute = function (name, val) {
        var _a;
        if (((_a = this.parentForm.settings) === null || _a === void 0 ? void 0 : _a.injectAttribute) === true)
            this.fieldNode.setAttribute(name, val);
    };
    Field.prototype.toggleAttribute = function (name, val, forced) {
        var _a;
        if (forced === void 0) { forced = false; }
        if (forced || ((_a = this.parentForm.settings) === null || _a === void 0 ? void 0 : _a.injectAttribute) === true) {
            this.fieldNode[name] = val;
        }
    };
    return Field;
}());
/* harmony default export */ var classes_Field = (Field_Field);

// CONCATENATED MODULE: ./src/core/global/events/FormEvent.ts
var Form;
(function (Form) {
    Form["onInit"] = "onInit";
...
// CONCATENATED MODULE: ./src/core/classes/SubmitButton.ts

var SubmitButton_SubmitButton = (function () {
    function SubmitButton(parentForm) {
        this.parentForm = parentForm;
    ...
    SubmitButton.prototype.checkButton = function () {
        if (this.buttonNode) {
            var submitBtnName = this.buttonNode.getAttribute("name");
    ...
    SubmitButton.prototype.extractMessages = function () {
        var _a;
        ...
        this.submittingText = ((_a = this.buttonNode) === null || _a === void 0 ? void 0 : _a.getAttribute("cf-submitting-msg")) || null;
    };
    SubmitButton.prototype.reRender = function () {
    ...
    SubmitButton.prototype.disable = function (bol) {
        this.buttonNode.disabled = bol;
    };
    return SubmitButton;
}());
/* harmony default export */ var classes_SubmitButton = (SubmitButton_SubmitButton);

// CONCATENATED MODULE: ./src/core/classes/abstract/EventEmitter.ts
...
// CONCATENATED MODULE: ./src/core/classes/CleverFormData.ts
...
var CleverFormData_CleverFormData = (function (_super) {
    __extends(CleverFormData, _super);
    function CleverFormData(config) {
        var _this = _super.call(this) || this;
        _this.focusedField = null;
        _this.configObj = config;
        _this.id = config.id;
        _this.formNode = document.getElementById(config.id);
        _this.checkRequiredParam();
        _this.validateParam();
        _this.otherValidation(config.id);
        _this.rules = config.rules;
        _this.formEvents = config.formEvents;
        _this.addEventsInternally();
        _this.cssClass = config.cssClass;
        _this.setDefaultSettings();
        _this.setDefaultStates();
        _this.fields = _this.getFormFieldsInfo();
        _this.submitBtn = new classes_SubmitButton(_this);
        _this.setNativeSubmit();
        _this.setSubmitListener();
        _this.checkIfHasFileInput();
        _this.states.isInitialized = true;
        _this.$emit(Form.onInit, []);
        return _this;
    }
    CleverFormData.prototype.checkIfHasFileInput = function () {
    ...
    CleverFormData.prototype.addEventsInternally = function () {
        var _a, _b, _c;
        if ((_a = this.formEvents) === null || _a === void 0 ? void 0 : _a.onInit)
            this.$on(Form.onInit, this.formEvents.onInit);
        if ((_b = this.formEvents) === null || _b === void 0 ? void 0 : _b.onError)
            this.$on(Form.onError, this.formEvents.onError);
        if ((_c = this.formEvents) === null || _c === void 0 ? void 0 : _c.onSuccess)
            this.$on(Form.onSuccess, this.formEvents.onSuccess);
    };
    CleverFormData.prototype.setNativeSubmit = function () {
        var _this = this;
        this.nativeSubmit = this.formNode.submit.bind(this.formNode);
        this.formNode.submit = function () {
            console.warn("You can only submit the form via Cleverform.\n " + App.Name + " managed form submition (with id of '" + _this.id + "').");
        };
    };
    CleverFormData.prototype.runNativeSubmit = function () {
        this.states.isSubmitting = true;
        this.submitBtn.reRender();
        this.nativeSubmit();
    };
    CleverFormData.prototype.setDefaultSettings = function () {
        var _a, _b, _c, _d, _e, _f;
        this.settings = {
            submitDelay: (_b = (_a = this.configObj) === null || _a === void 0 ? void 0 : _a.settings) === null || _b === void 0 ? void 0 : _b.submitDelay,
            lang: (_d = (_c = this.configObj) === null || _c === void 0 ? void 0 : _c.settings) === null || _d === void 0 ? void 0 : _d.lang,
            injectAttribute: (_f = (_e = this.configObj) === null || _e === void 0 ? void 0 : _e.settings) === null || _f === void 0 ? void 0 : _f.injectAttribute,
        };
    };
    CleverFormData.prototype.setDefaultStates = function () {
        this.states = {
            isInitialized: false,
            isSubmitting: false,
            activeErrors: null,
    ...
    CleverFormData.prototype.checkRequiredParam = function () {
    };
    CleverFormData.prototype.validateParam = function () {
    };
    CleverFormData.prototype.otherValidation = function (formId) {
        if (!this.formNode)
            throw new classes_CF_Error(Error_Code.Form_Not_Found, "(Form id: '" + formId + "')");
        if (this.formNode.tagName !== 'FORM')
            throw new classes_CF_Error(Error_Code.Form_Id_Not_In_Form_Tag, "('" + formId + "' id was found in <" + this.formNode.tagName.toLowerCase() + "> tag/element.)");
        if (formCollections.formExist(formId))
            throw new classes_CF_Error(Error_Code.Form_Already_Initialized, "(Form id: '" + formId + "')");
    };
    CleverFormData.prototype.getFormFieldsInfo = function () {
        var _a, _b;
        var nodeFieldsArr = this.formNode.querySelectorAll('input[name]:not([name=""]) , select[name]:not([name=""]) , textarea[name]:not([name=""])');
        var fields = {};
        if (nodeFieldsArr.length > 0) {
            for (var i = 0; i < nodeFieldsArr.length; i++) {
                if (nodeFieldsArr[i].getAttribute("name")) {
                    var node = nodeFieldsArr[i];
                    var fieldName = nodeFieldsArr[i].getAttribute("name");
                    if (fieldName === 'submit') {
                        continue;
                    }
                    var customName = (_a = this.configObj.customName) === null || _a === void 0 ? void 0 : _a[fieldName];
                    var tagName = nodeFieldsArr[i].tagName;
                    var type = (_b = nodeFieldsArr[i].getAttribute("type")) === null || _b === void 0 ? void 0 : _b.toLowerCase();
                    var rawRules = this.rules[fieldName];
                    fields[fieldName] = new classes_Field(this, node, fieldName, customName || null, tagName, type || null, rawRules);
                }
                else {
    ...
    CleverFormData.prototype.validateAllFields = function () {
        for (var fieldName in this.fields) {
            if (this.fields.hasOwnProperty(fieldName)) {
    ...
    CleverFormData.prototype.getFieldsError = function () {
        var errors = {};
        for (var fieldName in this.fields) {
            if (this.fields.hasOwnProperty(fieldName)) {
                var field = this.fields[fieldName];
    ...
    CleverFormData.prototype.getData = function (onlyValidated) {
        if (onlyValidated === void 0) { onlyValidated = false; }
        var data = {};
        for (var fieldName in this.fields) {
            if (this.fields.hasOwnProperty(fieldName)) {
                var field = this.fields[fieldName];
    ...
    CleverFormData.prototype.getFormData = function () {
        return new FormData(this.formNode);
    };
    CleverFormData.prototype.getFieldsErrorCount = function () {
        var errors = 0;
        for (var fieldName in this.fields) {
            if (this.fields.hasOwnProperty(fieldName)) {
                var field = this.fields[fieldName];
    ...
    CleverFormData.prototype.setSubmitListener = function () {
        var _this = this;
    ...
    CleverFormData.prototype.startValidate = function () {
        var _this = this;
        var _a;
        ...
        var errorsCount = this.getFieldsErrorCount();
        if (errorsCount === 0) {
            setTimeout(function () {
                var _a;
                if ((_a = _this === null || _this === void 0 ? void 0 : _this.formEvents) === null || _a === void 0 ? void 0 : _a.onSuccess) {
                    _this.$emit(Form.onSuccess, [_this.getData(true), _this.getFormData(), _this.runNativeSubmit.bind(_this)]);
                    _this.states.isSubmitting = false;
                    _this.submitBtn.reRender();
                }
                else {
                    _this.runNativeSubmit();
                }
            }, ((_a = this.settings) === null || _a === void 0 ? void 0 : _a.submitDelay) || Default.Submit_Delay);
        }
        else {
    ...
    CleverFormData.prototype.reset = function () {
        var rawData = this.getData(false);
        this.formNode.reset();
        for (var fieldName in this.fields) {
            if (this.fields.hasOwnProperty(fieldName)) {
                var field = this.fields[fieldName];
    ...
    return CleverFormData;
}(EventEmitter));


// CONCATENATED MODULE: ./src/core/states/formCollections.ts

var formCollections_FormCollections = (function () {
    function FormCollections() {
        this.forms = {};
    }
    FormCollections.prototype.addNewForm = function (config) {
        return this.forms[config.id] = new CleverFormData_CleverFormData(config);
    };
    FormCollections.prototype.formExist = function (formId) {
        return this.forms[formId] ? true : false;
    };
    FormCollections.getInstance = function () {
...
var formCollections = formCollections_FormCollections.getInstance();


// CONCATENATED MODULE: ./src/core/states/index.ts


// CONCATENATED MODULE: ./src/core/assets/cssDomInjector.ts


function cssDomInjector() {
    var ccStyles = [
...
// CONCATENATED MODULE: ./src/core/classes/CleverForm.ts
...
cssDomInjector();
var CleverForm_CleverForm = (function () {
    function CleverForm(config) {
        try {
            if (!(this instanceof CleverForm))
                throw new classes_CF_Error(Error_Code.Constructor_No_New_Keyword);
            Object.defineProperty(this, "id", { get: function () {
                    return config.id;
                }
            });
            var cfData = formCollections.addNewForm(config);
            var fields_1 = cfData.fields;
            var _loop_1 = function (fieldName) {
                if (Object.prototype.hasOwnProperty.call(fields_1, fieldName)) {
                    Object.defineProperty(this_1, fieldName, {
                        get: function () { return fields_1[fieldName].val(); },
                        set: function (newVal) { return fields_1[fieldName].setVal(newVal); },
                    });
                }
            };
            var this_1 = this;
            for (var fieldName in fields_1) {
                _loop_1(fieldName);
            }
            Object.freeze(this);
        }
        catch (error) {
            if (!(error instanceof classes_CF_Error)) {
                new classes_CF_Error(Error_Code.Unknown, error);
                throw error;
            }
        }
    }
    CleverForm.prototype.validate = function () {
        formCollections.forms[this.id].startValidate();
    };
    CleverForm.prototype.reset = function () {
        return formCollections.forms[this.id].reset();
    };
    CleverForm.prototype.rawData = function () {
        return formCollections.forms[this.id].getData();
    };
    CleverForm.addRule = function (ruleObj) {
        try {
            if (typeof ruleObj !== "object") {
                throw new classes_CF_Error(Error_Code.Custom_Rule_Error, "addRule method is expecting an object parameter. " + typeof ruleObj + " is detected.");
            }
            if (typeof ruleObj.name !== "string" || ruleObj.name.trim() == '') {
                throw new classes_CF_Error(Error_Code.Custom_Rule_Error, "name property must be a valid string");
            }
            if (typeof ruleObj.validate !== "function") {
                throw new classes_CF_Error(Error_Code.Custom_Rule_Error, "validate property must be a callback function. " + typeof ruleObj.validate + " is detected.");
            }
            var customName = ruleObj.name.trim();
            var errorMessage = ruleObj.errorMessage.trim();
            var customRule = {
                name: customName,
                default: false,
                checkAndSerializeParams: function () {
                    return null;
                },
    ...
    CleverForm.customErrorMessage = function (messageObj) {
        try {
            if (typeof messageObj !== "object") {
                throw new classes_CF_Error(Error_Code.Custom_ErrMsg_Error, "customErrorMessage method is expecting an object parameter. " + typeof messageObj + " is detected.");
            }
            for (var ruleName in messageObj) {
                if (messageObj.hasOwnProperty(ruleName)) {
                    var customMessage = messageObj[ruleName];
...
/* harmony default export */ var classes_CleverForm = (CleverForm_CleverForm);

// CONCATENATED MODULE: ./src/core/index.ts


/* harmony default export */ var core = __webpack_exports__["default"] = (classes_CleverForm);
